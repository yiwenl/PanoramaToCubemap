...
var _alfridMin = require('./libs/alfrid.min.js');
...
var SceneApp = function (_alfrid$Scene) {
	...
	_createClass(SceneApp, [{
		...
		value: function _initTextures() {
			...
			this._texture = new _alfridMin2.default.GLTexture(image);

			this.camera.setPerspective(90 * Math.PI / 180, GL.aspectRatio, 0.1, 1000);
			this.orbitalControl.radius.value = 2.;

			this.cameraCube = new _alfridMin2.default.CameraCube();
			this.orbitalControl.lockZoom(true);
			this.orbitalControl.inverseControl();

			this.fboSize = params.size;
			this._fbo = new _alfridMin2.default.FrameBuffer(this.fboSize, this.fboSize);

			window.addEventListener('keydown', function (e) {
				return _this2._onKey(e);
			});
		}
	}, {
		key: 'setNewImage',
		value: function setNewImage(data) {
			this._texture = new _alfridMin2.default.GLTexture(data);
		}
	}, {
		key: 'updateFboSize',
		value: function updateFboSize() {
			this.fboSize = params.size;
		...
		key: '_saveImage',
		value: function _saveImage(faceName) {
			var gl = GL.gl;
		...
		key: 'saveCubeImage',
		value: function saveCubeImage() {
			var imgNames = ['px', 'nx', 'py', 'ny', 'pz', 'nz'];
			for (var i = 0; i < 6; i++) {
				this._fbo.bind();
				GL.clear();
...
},{"./ViewSkybox":5,"./ViewSphere":6,"./libs/alfrid.min.js":8}],5:[function(require,module,exports){
'use strict';
...
var ViewSkybox = function (_alfrid$View) {
	...
	_createClass(ViewSkybox, [{
		...
		value: function _init() {
			this.mesh = _alfridMin2.default.Geom.skybox(12);
		}
	}, {
		key: 'render',
...
},{"./libs/alfrid.min.js":8}],6:[function(require,module,exports){
'use strict';
...
var ViewSphere = function (_alfrid$View) {
	...
	_createClass(ViewSphere, [{
		key: '_init',
		value: function _init() {
			this.mesh = _alfridMin2.default.Geom.sphere(5, 24, false, true);
		}
	}, {
		key: 'render',
		value: function render(texture) {
...
},{"./libs/alfrid.min.js":8}],7:[function(require,module,exports){
'use strict';
...
function _init() {
	...
	//	INIT GL TOOL
	_alfridMin2.default.GL.init(canvas, { preserveDrawingBuffer: true });
	// alfrid.GL.init(canvas);

	//	INIT SCENE
	scene = new _SceneApp2.default();
